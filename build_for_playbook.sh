...
FONTCONFIG_CFLAGS="-I${QNX_TARGET}/usr/include/fontconfig" \
FONTCONFIG_LIBS="-L${QNX_TARGET}/armle-v7/usr/lib -lfontconfig" \
FREETYPE_CFLAGS="-I${QNX_TARGET}/usr/include/freetype2" \
FREETYPE_LIBS="-L${QNX_TARGET}/armle-v7/usr/lib -lfreetype" \
